...
function editButton($tid='')
{
    return      '<a type="button" href="?p=modexpense&type=edit&tid=' . $tid . '" class="btn btn-outline-primary">
...
{
    return      '<a type="button" href="?p=modexpense&type=delete&tid=' . $tid . '" class="btn btn-outline-danger">
